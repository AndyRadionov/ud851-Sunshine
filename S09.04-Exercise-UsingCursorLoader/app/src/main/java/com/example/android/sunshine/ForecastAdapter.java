...
//      COMPLETED (7) Generate a weather summary with the date, description, high and low
        ...
        String friendlyDate = SunshineDateUtils.getFriendlyDateString(mContext, weatherDate, false);
        ...
        String summary = friendlyDate + " - " + weatherDescription + " - " + highAndLowTemp;
...
//  COMPLETED (11) Create a new method that allows you to swap Cursors.void swapCursor(Cursor newCursor) {
