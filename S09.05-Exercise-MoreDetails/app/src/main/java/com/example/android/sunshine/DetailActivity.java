...
//  COMPLETED (20) Create a constant int to identify our loader used in DetailActivity
    private static final int WEATHER_DETAIL_LOADER = 42;
...
//  COMPLETED (11) Declare TextViews for the date, description, high, low, humidity, wind, and pressure
    ...
    private TextView mWeatherDescriptionDisplay;
    private TextView mWeatherHighTempDisplay;
    private TextView mWeatherLowTempDisplay;
...
//      COMPLETED (13) Find each of the TextViews by ID
        ...
        mWeatherDescriptionDisplay = (TextView) findViewById(R.id.tv_weather_description);
        mWeatherHighTempDisplay = (TextView) findViewById(R.id.tv_weather_high_temp);
        mWeatherLowTempDisplay = (TextView) findViewById(R.id.tv_weather_low_temp);
...
//      COMPLETED (26) Display a readable data string
        ...
        String friendlyDate = SunshineDateUtils.getFriendlyDateString(this, longDate, true);
        mWeatherDateDisplay.setText(friendlyDate);

//      COMPLETED (27) Display the weather description (using SunshineWeatherUtils)
        int weatherId = data.getInt(INDEX_WEATHER_CONDITION_ID);
        String description = SunshineWeatherUtils.getStringForWeatherCondition(this, weatherId);
        mWeatherDescriptionDisplay.setText(description);
