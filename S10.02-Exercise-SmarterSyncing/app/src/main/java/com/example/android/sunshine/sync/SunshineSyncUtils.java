...
//  COMPLETED (1) Declare a private static boolean field called sInitialized
    ...
    public static synchronized void initialize(final Context context) {
        ...
        final Uri weatherUri = WeatherContract.WeatherEntry.CONTENT_URI;
        final String[] projection = {WeatherContract.WeatherEntry._ID};
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                Cursor cursor = context.getContentResolver().query(weatherUri, projection,
                        selection, null, null);
